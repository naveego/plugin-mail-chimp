...
using PluginMailChimp.API.Write;
using PluginMailChimp.DataContracts;
using PluginMailChimp.Helper;

namespace PluginMailChimp.Plugin
{
    public class Plugin : Publisher.PublisherBase
    {
        ...
        public override async Task<ConfigureWriteResponse> ConfigureWrite(ConfigureWriteRequest request, ServerCallContext context)
        {
            ...
            var templates = await Write.GetAllTemplatesAsync(_apiClient);
            
            var schemaJson = Write.GetSchemaJson(templates);
            ...
            try
            {
                ...
                var schema = await Write.GetSchemaForSettingsAsync(formData, templates);
